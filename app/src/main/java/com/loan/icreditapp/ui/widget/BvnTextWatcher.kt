...
class BvnTextWatcher : TextWatcher {
...
//删除字符串从0~sb_length-1处的内容 (这个方法就是用来清除StringBuffer中的内容的)
        ...
        for (i in 0 until s.length) {
            if (sb.length != 1 && sb.length != 3 && sb.length != 5 && sb.length != 7 &&
                sb.length != 9 && sb.length != 11 && sb.length != 13 && sb.length != 15 &&
                sb.length != 17 && sb.length != 19 && sb.length != 21  && s.toString()[i] == ' ') {
                continue
            } else {
                sb.append(s.toString()[i]);
                if ((sb.length == 2 || sb.length == 4 || sb.length == 6 || sb.length == 8||
                            sb.length == 10 || sb.length == 12 || sb.length == 14 || sb.length == 16 ||
                            sb.length == 18 || sb.length == 20
                            )
